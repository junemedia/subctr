...
/*
Method: GET or POST
Posting URL: http://wim.popularliving.com/wim_api.php
Required Fields: email=&sublists=&subcampid=&ipaddr=&keycode=ggjig592fkg785kscm8473
Example: http://wim.popularliving.com/wim_api.php?email=samirp@silvercarrot.com&sublists=395,396&subcampid=2679&ipaddr=216.180.167.121&keycode=ggjig592fkg785kscm8473&source=
*/
...
foreach($parts as $list_parts) {
	...
	$campaigner = "INSERT IGNORE INTO campaigner (dateTime,email,ipaddr,oldListId,newListId,subcampid,source,subsource,type,isProcessed)
					VALUES (NOW(),\"$email\",\"$ipaddr\",\"$list_parts\",\"$new_listid\",\"$subcampid\",\"$source\",\"$subsource\",'sub','N')";
