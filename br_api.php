...
if(strtolower($source) =='betterrecipesemailsignup')
{
	$subcampid = 4375; //Better Recipes Email Signup 0615
}

if(strtolower($source) =='betterrecipesuserregistration')
{
	$subcampid = 4376; //Better Recipes User Registration 0615
}

if(strtolower($source) =='SweepsRegistrationBR')
{
        $subcampid = 4377; //Better Recipes Email Signup 0615
}

if(strtolower($source) =='SweepsRegistrationR4L')
{
        $subcampid = 4378; //Better Recipes User Registration 0615
}
...
$insert_api_lead = "INSERT IGNORE INTO api (dateTimeAdded,email,listid,subcampid,ipaddr,subsource) VALUES (NOW(),\"$email\",\"$sublists\",\"$subcampid\",\"$ipaddr\",\"$source\")";
