...
$title_583 = 'The Feed by SavvyFork';
$listing_conf = '';
...
if ($_POST['submit'] == 'Unsubscribe') {
	...
	if ($message == '') {
		...
		echo "<table width='500px' align='center'><tr><td><font style='font-family:arial;font-style:normal;font-size:12px;font-weight:normal;text-decoration:none;'>
				...
				re-subscribe <a href='http://www.savvyfork.com/'>here</a>.
				</font></td></tr></table>";
...
<html>
<head>
<title>Unsubscribe From SavvyFork Newsletters</title>
<style>
body {
...
function CheckAll () {
	document.getElementById('583').checked = true;
}
function UnCheckAll () {
	document.getElementById('583').checked = false;
}
</script>
</head>
<body>
<form name="form1" method="POST" action="<?php echo $_SERVER['PHP_SELF']?>" onsubmit="return check_fields();">
	...
	<table width="500px" align="center" style="font-style: normal;font-size: 12px;font-weight: normal;text-decoration: none;">
		<tr>
			...
			<font color="#F99D1C" size="4" style="font-family: arial;">Unsubscribe From SavvyFork Newsletters</font>
			</td>
		</tr>
	</table>
	...
	<table width="500px" align="center" id="unsub_form" style="font-style: normal;font-size: 12px;font-weight: normal;text-decoration: none;">
		...
		<tr>
			<td><input type="checkbox" id='583' name="aListId[]" value="583" <?php if ($id == '583') { echo ' checked '; } ?>> <b><?php echo $title_583; ?></b></td>
		</tr>
