...
if ($_POST['submit'] == 'Submit') {
	...
	if ($_REQUEST['action_stay'] == 'Y') {
		header("Location:http://fitfab.popularliving.com/subctr/unsub/ff/stay.php?listid=$listid&jobid=$jobid&email=$email");
		exit;
	}
	...
	if ($_REQUEST['action_unsub'] == 'Y') {
		...
		if ($message == '') {
			...
			header("Location:http://fitfab.popularliving.com/subctr/unsub/ff/unsub_conf.php?listid=$listid&jobid=$jobid&email=$email");
			exit;
		}
	}
} else {
