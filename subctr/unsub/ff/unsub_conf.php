...
if (ctype_digit(trim($_REQUEST['listid']))) {
	$pixel = "<img src='http://www.fitandfabliving.com/unsub/".trim($_REQUEST['listid'])."_UnsubConf.html' width='0' height='0' border='0'>";
}
...
function redirectToHomePage () {
	window.top.location = "http://www.fitandfabliving.com/";
}
