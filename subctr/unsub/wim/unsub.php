...
if ($_POST['submit'] == 'Submit') {
	...
	if ($_REQUEST['action_stay'] == 'Y') {
		header("Location:http://wim.popularliving.com/subctr/unsub/wim/stay.php?listid=$listid&jobid=$jobid&email=$email");
		exit;
	}
	...
	if ($_REQUEST['action_unsub'] == 'Y') {
		...
		if ($message == '') {
			...
			header("Location:http://wim.popularliving.com/subctr/unsub/wim/unsub_conf.php?listid=$listid&jobid=$jobid&email=$email");
			exit;
		}
	}
} else {
