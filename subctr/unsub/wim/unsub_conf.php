...
if (ctype_digit(trim($_REQUEST['listid']))) {
	$pixel = "<img src='http://www.workitmom.com/unsub/".trim($_REQUEST['listid'])."_UnsubConf.html' width='0' height='0' border='0'>";
}
...
function redirectToHomePage () {
	window.top.location = "http://www.workitmom.com/";
}
...
<table width="500" align="center" style="font-style: normal;font-size: 12px;font-weight: normal;text-decoration: none;">
	<tr>
		<td>
			<font color="#46ABCC" size="4" style="font-family: arial;">
