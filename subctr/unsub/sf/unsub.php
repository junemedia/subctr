...
if (isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
  ...
  if (isset($_REQUEST['action_stay']) && $_REQUEST['action_stay'] == 'Y') {
    header("Location:/subctr/unsub/sf/stay.php?listid=$listid&jobid=$jobid&email=$email");
    exit;
  }
  ...
  if ($_REQUEST['action_unsub'] == 'Y') {
    ...
    if ($message == '') {
      ...
      header("Location:/subctr/unsub/sf/unsub_conf.php?listid=$listid&jobid=$jobid&email=$email");
      exit;
    }
  }
} else {
