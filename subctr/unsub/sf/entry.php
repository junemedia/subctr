...
$listid = isset ($_REQUEST['listid']) ? trim($_REQUEST['listid']) : '';
$jobid  = isset ($_REQUEST['jobid'])  ? trim($_REQUEST['jobid'])  : '0';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset ($_POST['action']) && $_POST['action'] === 'stay') {
    $pixel = "<img src='http://www.savvyfork.com/unsub/".$listid."_Stay.html' width='0' height='0' border='0'>";
    include  'template/stay.html';
  }

  // otherwise unsubscribe them
  else {
    $pixel = "<img src='http://www.savvyfork.com/unsub/".$listid."_UnsubConf.html' width='0' height='0' border='0'>";
