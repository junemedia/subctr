...
if (isset($_POST['submit']) && $_POST['submit'] == 'Submit') {
    ...
    if ($message == '') {
      ...
      if (mysql_num_rows($check_query_result) > 0) {
        ...
        $campaigner = "INSERT IGNORE INTO campaigner (dateTime,email,ipaddr,oldListId,newListId,subcampid,source,subsource,type,isProcessed)
                VALUES (NOW(),\"$email\",\"$user_ip\",\"$listid\",\"$new_listid\",\"$subcampid\",\"R4LUnsubLink\",\"\",'unsub','Y')";
      ...
      header("Location:/subctr/unsub/r4l/unsub_conf.php?listid=$listid&jobid=$jobid&email=$email");
      exit;
    }
  }
} else {
  ...
  $pixel = "<img src='http://www.recipe4living.com/unsub/".$listid."_Unsub.html' width='0' height='0' border='0'>";
}
