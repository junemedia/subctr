...
if ($host == 'sf') { $loader_img = 'sf_loader.gif'; }
if ($host == 'r4l') { $loader_img = 'r4l_loader.gif'; }
if ($host == 'wim') { $loader_img = 'wim_loader.gif'; }
if ($host == 'fitfab') { $loader_img = 'fitfab_loader.gif'; }
if ($host == 'br') { $loader_img = 'br_loader.gif'; }
