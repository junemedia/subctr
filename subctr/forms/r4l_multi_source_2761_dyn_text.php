...
if ($_POST['submit'] == 'Submit for FREE Access') {
	...
	if ($error != '') {
		...
		$message = "<meta http-equiv='Refresh' content='1;url=http://www.focusforfree.com/dispatch2.asp?home=298-29135P&email=$email' />
					<tr><td colspan='2' style='color:black;padding:20px;' align='center' valign='top'><h3>
					Thank you for signing up for the Recipe4Living newsletter!  
...
<input type="hidden" value="<?php echo $text; ?>" name="text" id="text">
<input type="hidden" value="<?php echo $src; ?>" name="src" id="src">
<table width="685px" height="400px" align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;font-family: verdana;background-image:url('http://pics.recipe4living.com/r4l_dyn_text_LP2.jpg');background-repeat:no-repeat;">
<tr>
	<td valign="top" style="padding-top:120px;" align="center">
		<div style="padding-left:80px;width:250px;font-family:'Century Gothic';font-size:25px;font-style:italic;font-weight:bold;color:white;">
			Like This <?php echo $text; ?> Recipe? Sign Up For Our Free Newsletter for Great Recipes Like This and 1,000's More.
		</div>
	</td>
</tr>
</table>
...
<?php echo $message; if ($signup_success) { ?>
<!-- MSN Tracking Pixel = START --><!-- MSN Tracking Pixel = END -->
<?php exit; } ?>
<tr>
...
<tr>
	<td colspan="2" align="center">
		<font size="1"><a href="http://www.recipe4living.com/terms" target="_blank">Terms & Conditions</a> | 
		<a href="http://www.recipe4living.com/about" target="_blank">About</a> | 
		<a href="http://www.recipe4living.com/index/subctr" target="_blank">Unsubscribe</a> | 
		<a href="http://www.recipe4living.com/privacy" target="_blank">Privacy</a>
		</font>
	</td>
</tr>
</table>
