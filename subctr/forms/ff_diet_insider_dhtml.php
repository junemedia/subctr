	...
	if ($error != '') {
		...
		foreach ($aJoinListId as $listid) {
			...
			$insert_query = "INSERT IGNORE INTO joinEmailSub (dateTime,email,ipaddr,listid,subcampid,source,subsource)
							VALUES (NOW(),\"$email\",\"$user_ip\",\"$listid\",\"3074\",\"FFDHTML\",\"FFDHTMLDietInsider\")";
			...
			$campaigner = "INSERT IGNORE INTO campaigner (dateTime,email,ipaddr,oldListId,newListId,subcampid,source,subsource,type,isProcessed)
							VALUES (NOW(),\"$email\",\"$user_ip\",\"$listid\",\"$new_listid\",\"3074\",\"FFDHTML\",\"FFDHTMLDietInsider\",'sub','N')";
		...
		if ($build_list_id != '') {
			...
			$send_to_arcamax = Arcamax($email,$build_list_id,'3074',$user_ip,'sub'); // sub or unsub
			...
			$insert_log = "INSERT IGNORE INTO arcamaxNewLog (dateTime,email,listid,subcampid,ipaddr,type,response)
						VALUES (NOW(),\"$email\",\"$build_list_id\",\"3074\",\"$user_ip\",\"sub\",\"$send_to_arcamax\")";
		...
		$message = "<tr><td colspan='2' style='color:black;padding:20px;' align='center' valign='top'><h3>
					Thank you for signing up for Fit&FabLiving's Diet Insider!  
					You will receive a welcome e-mail confirming your subscription. 
					Please allow 24-48 hours to receive your first newsletter.
					</h3></td></tr>";
		$pixel = "<img src='http://".trim($_SERVER['SERVER_NAME'])."/subctr/forms/stats.php?a=s&f=FFDHTMLDietInsider' width='0' height='0' border='0' />";
	}
} else {
	$attempt = false;
	$pixel = "<img src='http://".trim($_SERVER['SERVER_NAME'])."/subctr/forms/stats.php?a=d&f=FFDHTMLDietInsider' width='0' height='0' border='0' />";
}
...
<table width="610px" height="300px" align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;font-family: verdana;background-image:url('http://pics.fitandfabliving.com/ff_new_year_dhtml.jpg');background-repeat:no-repeat;">
<tr valign="top">
...
<tr>
	<td colspan="2" align="center">
		<font size="1"><a href="http://www.fitandfabliving.com/index.php/terms-of-use.html?gclid=1" target="_blank">Terms & Conditions</a> | 
		<a href="http://www.fitandfabliving.com/index.php/aboutus.html?gclid=1" target="_blank">About</a> | 
		<a href="http://www.fitandfabliving.com/index.php/component/content/article/4753.html?gclid=1" target="_blank">Unsubscribe</a> | 
		<a href="http://www.fitandfabliving.com/index.php/privacy-policy.html?gclid=1" target="_blank">Privacy</a>
		</font>
	</td>
</tr>
</table>
