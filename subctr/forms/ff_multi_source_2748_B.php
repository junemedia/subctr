...
<table width="640px" height="300px" align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:11px;font-family: verdana;background-image:url('http://pics.fitandfabliving.com/dhtml/2748_high_bp.jpg');background-repeat:no-repeat;">
<tr valign="top">
...
<tr>
	<td colspan="2" align="center">
		<font size="1">
			<input type="checkbox" id="agree" name="agree" value="Y" <?php if ($agree == 'Y') { echo ' checked '; } ?>> I accept the <a href="http://www.fitandfabliving.com/index.php/terms-of-use.html?gclid=1" target="_blank">Terms & Conditions</a> 
