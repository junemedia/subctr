...
<?php echo $pixel; ?>
	<?php echo $message; if ($signup_success == true) { exit; } ?>
		...
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="395" id="2"> <b title="Stretch your dollar further with budget-friendly recipes!" style="cursor: help;">Budget Cooking</b> <b class="small">(3 times/week)</b>	
			</td>
		</tr>
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="392" id="3"> <b title="Find new impressive appetizers, party drinks and party-stopping tips!" style="cursor: help;">Party Tips & Recipes</b> <b class="small">(weekly)</b>
			</td>
		</tr>
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="394" id="4"> <b title="Simple, easy to make recipes. Perfect for a chef on-the-go." style="cursor: help;">Quick & Easy Recipes</b> <b class="small">(3 times/week)</b>
			</td>
		</tr>
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="511" id="5"> <b title="Set it and forget it! Easy recipes designed for your slow cooker." style="cursor: help;">Crockpot Creations</b> <b class="small">(3 times/week)</b>
			</td>
		</tr>
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="539" id="6"> <b title="Find the perfect dish for your next home-cooked meal!" style="cursor: help;">Casserole Cookin'</b> <b class="small">(2 times/week)</b>
			</td>
		</tr>
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="554" id="7" checked> <b title="Recreate your favorite restaurant dishes at home with these easy recipes sent to your inbox!" style="cursor: help;">Copycat Classics</b> <b class="small">(2 times/week)</b>
			</td>
		</tr>
		<tr>
			<td class="checkBox">
				<input style="cursor: pointer;" type="checkbox" name="aJoinListId[]" value="574" id="8"> <b title="Looking for dishes suitable for diabetics? Sign up and receive diabetic-friendly recipes for appetizers, desserts, and everything in between!" style="cursor: help;">Diabetic-Friendly Dishes - NEW!</b> <b class="small">(2 times/week)</b>
			</td>
		</tr>
		<tr>
			<td>
