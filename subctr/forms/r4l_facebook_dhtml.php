...
<div id="divBG">
	...
	* E-mail Address: <input style="background-color: #fdee8f;" type="text" name="email" value="" size="30" maxlength="100">&nbsp;&nbsp;<INPUT style="vertical-align:bottom;" TYPE="image" SRC="http://pics.recipe4living.com/subctrSUbutton.jpg" BORDER="0" ALT="Submit Form" />
	...
	<div id="nlList">
	<table id="nlTable" align="left" border="0" cellpadding="5" cellspacing="0">
						<tr>
							<td>
						...
						<tr>
							<td>
								<input type="checkbox" name="aJoinListId[]" value="574" id="8"> <b>Diabetic-Friendly Dishes - NEW!<span style="font-size: 11pt;"> (2 issues/week)</span></b>
							</td>
						</tr>
					</table>
	</div>
